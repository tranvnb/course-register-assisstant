...
export const getUserTimetable = createAsyncThunk('courses/selected', (timetableId, thunkAPI) => {
  if (timetableId !== thunkAPI.getState().dashboard.selectedTimetableId) {
    thunkAPI.dispatch(selectTimetableId(timetableId))
...
const DashboardSlice = createSlice({
  ...
  extraReducers: {
    ...
    [getUserTimetable.pending]: (state, action) => {
